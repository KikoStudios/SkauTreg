...
export default function ProfileModal() {
    ...
    const resetForm = React.useCallback(() => {
        ...
        setDateOfBirth(viewer?.birthDate || (user?.unsafeMetadata?.dateOfBirth as string) || "");
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            showSuccess({
                title: "Profil uložen",
                message: "Kontakty a osobní údaje byly aktualizovány.",
                duration: 2500,
            });
        } catch (err: unknown) {
                            ...
                            {!isEditing ? (
                                ...
                                <div className={styles.editForm}>
                                    <div className={styles.sectionTabs}>
                                        <button
                                            type="button"
                                            className={`${styles.sectionTab} ${activeSection === "personal" ? styles.sectionTabActive : ""}`}
                                        ...
                                        <button
                                            type="button"
                                            className={`${styles.sectionTab} ${activeSection === "contact" ? styles.sectionTabActive : ""}`}
                                        ...
                                        <button
                                            type="button"
                                            className={`${styles.sectionTab} ${activeSection === "parents" ? styles.sectionTabActive : ""}`}
                                    ...
                                    <div className={styles.roleModeSwitch}>
                                        <button
                                            type="button"
                                            className={`${styles.roleModeButton} ${contactProfileType === "leader" ? styles.roleModeButtonActive : ""}`}
                                            onClick={() => setContactProfileType("leader")}
                                        >
                                            Vedoucí / Hl. vedoucí
                                        </button>
                                        <button
                                            type="button"
                                            className={`${styles.roleModeButton} ${contactProfileType === "rover" ? styles.roleModeButtonActive : ""}`}
                                            onClick={() => setContactProfileType("rover")}
                                        >
                                            Rover
                                        </button>
                                    </div>
